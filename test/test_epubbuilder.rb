...
class EPUBBuidlerTest < Test::Unit::TestCase
  ...
  def test_headline_level1
    ...
    assert_equal %Q|<a name="h1" /><h1 id='test'>第1章　this is test.</h1>\n|, @builder.raw_result
  end

  def test_headline_level1_without_secno
    @param["secnolevel"] = 0
    @builder.headline(1,"test","this is test.")
    assert_equal %Q|<a name="h1" /><h1 id='test'>this is test.</h1>\n|, @builder.raw_result
  end

  def test_headline_level2
    @builder.headline(2,"test","this is test.")
    assert_equal %Q|\n<a name="h1-1" /><h2 id='test'>1.1　this is test.</h2>\n|, @builder.raw_result
  end

  def test_headline_level3
    @builder.headline(3,"test","this is test.")
    assert_equal %Q|\n<a name="h1-0-1" /><h3 id='test'>this is test.</h3>\n|, @builder.raw_result
  end
