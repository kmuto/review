...
class TestASTComprehensive < Test::Unit::TestCase
  ...
  def test_code_blocks_ast_processing
    ...
    assert_equal 'Sample Code', list_block.caption_text
    assert_equal 'ruby', list_block.lang
    assert_equal false, list_block.line_numbers

    emlist_block = code_blocks.find { |n| n.caption_text == 'Ruby Example' && n.id.nil? }
    ...
    assert_equal 'Terminal Commands', cmd_block.caption_text
  end
  ...
  def test_table_ast_processing
    ...
    assert_equal 'Environment Variables', main_table.caption_text
